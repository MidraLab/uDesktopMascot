...
以下のような機能がメニューから利用できます。
* モデルの追加・変更
* アプリの設定変更
* アプリの終了
* (Windowsのみ)アプリの通知領域にアプリの収納 : アプリを最小化することができます。
  * 通知領域にアプリを収納すると、デスクトップ上に表示されるアプリのアイコンが通知領域に表示されます。
  * 通知領域のアイコンをクリックすることで、アプリをデスクトップ上に表示することができます。
* AIチャット機能 : AIチャット機能を利用することができます。
  * Qwen2モデルを使ったローカルモデル対応
